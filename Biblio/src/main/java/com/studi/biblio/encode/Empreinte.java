...
public class Empreinte {
    ...
    public static String getHash(String toHash){ //renvoie une empreinte sha256 du string donné en paramètre.
        return DigestUtils.sha256Hex(toHash);
    }


    public static String getSalt(int taille) {
    ...
    public static String getHashSalt(String password, String salt){ //renvoie une empreinte sha256 du string donné en paramètre auquel on a ajouté le sel.
        return getHash(password + salt);
    }
    public static boolean isValidPassword(String hash, String password, String salt){
